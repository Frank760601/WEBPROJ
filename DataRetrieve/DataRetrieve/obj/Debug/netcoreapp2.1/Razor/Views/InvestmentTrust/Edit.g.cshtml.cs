#pragma checksum "C:\webproject\WEBPROJ\DataRetrieve\DataRetrieve\Views\InvestmentTrust\Edit.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "42b33871b23857425e3cd18ae9ee03ea332475bf"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"42b33871b23857425e3cd18ae9ee03ea332475bf", @"/Views/InvestmentTrust/Edit.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "bf6f2042a2774e91baaac74db533275c", async() => {
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ad37ab3fc09946239cedf362daf567e8", async() => {
...
#line hidden
    ...
    function checkField() { 
        ...
        if (!$(""[name=NO]"").val()) {
            ...
            FieldError(""NO"", ""字串不可超過3個字元"")
            check = check && false;
        } else {
            FieldError(""NO"")
        }
        if (!$(""[name=NAME]"").val()) {
            FieldError(""NAME"", ""請輸入客戶名稱"")
            check = check && false;
        } else if ($(""[name=NAME]"").val().length > 50) {
            FieldError(""NAME"", ""字串不可超過50個字元"")
            check = check && false;
        } else {
            FieldError(""NAME"")
        }
        if (!$(""[name=IDNO]"").val()) {
            FieldError(""IDNO"", ""請輸入身分證字號或營利事業統一編號"")
            check = check && false;
        } else if (");
            WriteLiteral(@"$(""[name=IDNO]"").val().length > 10) {
            FieldError(""IDNO"", ""字串不可超過10個字元"")
            check = check && false;
        } else {
            FieldError(""IDNO"")
        }
